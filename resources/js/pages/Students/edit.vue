...
let student=props.student.data;
const form =useForm({
    name:student.name,
    email:student.email,
...
onMounted(()=>{
    updateSections(student.class.id);
})
                            ...
                            <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">
                                        Use this form to update student.
                                    </p>
                                </div>
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        v-model="form.name"
                                            ...
                                            :class="{'text-red-900 focus:ring-red-500 focus:border-red-500': form.errors.name}"
                                        />
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input
                                         v-model="form.email"
                                            ...
                                            autocomplete="email"
                                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                            :class="{'text-red-900 focus:ring-red-500 focus:border-red-500': form.errors.email}"
                                        />
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        >
                                            ...
                                            <option v-for="classe in classes.data" :key="classe.id" :value=" classe.id">{{classe.name}}</option>
                                        </select>
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <select
                                         v-model="form.section_id"
                                            id="section_id"
                                            class="mt-1 block w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                            :class="{'text-red-900 focus:ring-red-500 focus:border-red-500': form.errors.section_id}"
                                        >
