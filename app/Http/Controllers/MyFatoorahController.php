    ...
    public function callback()
    {
        try {
            ...
            if ($data->InvoiceStatus == "Paid") {
                DB::beginTransaction();
                $enrollment = Enrollment::findOrFail($data->CustomerReference);
                $enrollment->paid=true;
                $enrollment->save();
                // save the Transaction
                if (Transaction::where('enrollment_id',$enrollment->id)->where('InvoiceId',$data->InvoiceId)->first()) {
                    # code...
                ...
                DB::commit();
                $message='Enrollment and Transaction Done Successfully';
